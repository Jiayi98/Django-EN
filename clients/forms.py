...
class ClientForm(forms.ModelForm):
    # 该表单用于添加客户信息
    cname = forms.CharField(max_length=150,label='客户名称',required=False)
...
class BCForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('bc_name','bc_gender','bc_mobile','bc_wechat','bc_email','bc_position')
...
class FCForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ('fc_name','fc_gender','fc_mobile','fc_wechat','fc_email','fc_position')
